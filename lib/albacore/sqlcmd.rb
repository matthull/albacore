...
class SQLCmd
  ...
  def check_command
    ...
    sql2012cmdPath = File.join(drive,'program files','microsoft sql server','110','tools','binn', 'sqlcmd.exe')
    sql2008cmdPath = File.join(drive,'program files','microsoft sql server','100','tools','binn', 'sqlcmd.exe')
    sql2005cmdPath = File.join(drive,'program files','microsoft sql server','90','tools','binn', 'sqlcmd.exe')
    sql2012cmdPathx86 = File.join(drive,'program files (x86)','microsoft sql server','110','tools','binn', 'sqlcmd.exe')
    sql2008cmdPathx86 = File.join(drive,'program files (x86)','microsoft sql server','100','tools','binn', 'sqlcmd.exe')
    sql2005cmdPathx86 = File.join(drive,'program files (x86)','microsoft sql server','90','tools','binn', 'sqlcmd.exe')
